...
class SASFeatureModel(BaseModel):
    def __init__(self, args):
        ...
        self.item_rep_graph_attribute_rel = nn.Embedding(4, args.feature_dim, padding_idx=0)
    ...
    @classmethod
    def code(cls):
        return 'sasrec_attention_feature_v2'
    ...
    def get_logits(self, d):
        ...
        absolute_kernel_embeddings = [cate_emb, brand_emb, price_emb]
        #concat the representation from the graph and the init item embedding;
        ...
        def genRelFeature(feature):
            ...
            feature_valid = feature_valid_mask.type(torch.LongTensor).cuda()
