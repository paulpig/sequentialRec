...
class SASModel(BaseModel):
    ...
    @classmethod
    def code(cls):
        return 'graph_sasrec_improve_lightgcn_kgat_behavoir_rel_items_shared_lightgcn_add_attribute'
    ...
    def setUserItemRepFromGraph(self, user_rep_buy, item_rep_buy, user_rep_view, item_rep_view, user_ori, item_ori, k_user_ori, k_item_ori):
        ...
        self.user_rep_graph_attribute = user_rep_view #None
        self.item_rep_graph_attribute = item_rep_view #None

        self.user_ori = user_ori
        self.item_ori = item_ori

        self.k_user_ori = k_user_ori # None
        self.k_item_ori = k_item_ori # None
        return
