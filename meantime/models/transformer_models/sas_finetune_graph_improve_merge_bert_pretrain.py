...
class SASModel(BaseModel):
    ...
    @classmethod
    def code(cls):
        return 'sas_finetune_graph_improve_merge_b_pretrain'
    ...
    def forward(self, d):
        ...
        if self.training:
            ...
            candidate_embeddings_graph = self.item_rep_graph[x_unsqueeenze, :].reshape(x.size(0), x.size(1), -1)
    ...
    def get_loss(self, logits, labels, negative_labels):
        ...
        valid_labels_emb_graph = self.item_rep_graph[valid_labels, :]  # M x H
        ...
        valid_negative_labels_emb_graph = self.item_rep_graph[valid_negative_labels, :]  # M x H
