...
class SASModel(BaseModel):
    ...
    @classmethod
    def code(cls):
        return 'sas_finetune_graph_improve_using_graph_emb'


    def setUserItemRepFromGraph(self, user_rep_graph, item_rep_graph, graph_user_emb=None, graph_item_emb=None):
        """
        ...
        self.graph_user_emb = graph_user_emb
        self.graph_item_emb = graph_item_emb
        return
    ...
    def forward(self, d):
        ...
        if self.training:
            ...
            candidate_embeddings = self.graph_item_emb(x) #(bs, C, H)
    ...
    def get_loss(self, logits, labels, negative_labels):
        ...
        valid_labels_emb = self.graph_item_emb(valid_labels)  # M x H
        valid_negative_labels_emb = self.graph_item_emb(valid_negative_labels)  # M x H
