...
class SASModel(BaseModel):
    def __init__(self, args):
        ...
        # self.user_rep_graph_buy = TokenEmbeddingDirect(args)
        # self.item_rep_graph_buy = TokenEmbeddingDirect(args)
        self.user_rep_graph_attribute = TokenEmbeddingDirect(args)
    ...
    @classmethod
    def code(cls):
        return 'graph_sasrec_improve_lightgcn_kgat_init_both_emb_v2'
    ...
    def setUserItemRepFromGraphKGAT(self, user_rep_buy, item_rep_buy, user_rep_view, item_rep_view):
        """
        ...
        # self.user_rep_graph_buy.emb.weight.data.copy_(user_rep_buy)
        # self.item_rep_graph_buy.emb.weight.data.copy_(item_rep_buy)
        # self.user_rep_graph_attribute.emb.weight.data.copy_(user_rep_view)

        return

    def setUserItemRepFromGraphLightGCN(self, user_rep_buy, item_rep_buy, user_rep_view, item_rep_view):
        """
        The representations from the LightGCN model; 
        user_rep_graph: (|users|, dim)
        item_rep_graph: (|items|, dim)
