...
class GraphTrainer(AbstractTrainer):
    ...
    @classmethod
    def code(cls):
        return 'graph_sasrec_improve_using_graph_emb'
    ...
    def train(self):
        ...
        self.model.setUserItemRepFromGraph(self.user_hidden_rep, self.item_hidden_rep, self.graph_model.embedding_user, self.graph_model.embedding_item) #每次加载相同的hidden representatin, 不合理;
