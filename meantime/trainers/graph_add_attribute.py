...
import os
import pdb
from meantime.dataloaders.graph_add_attribute import GraphLoader
...
class GraphTrainer(AbstractTrainer):
    ...
    @classmethod
    def code(cls):
        return 'graph_sasrec_add_attribute'
    ...
    def train(self):
        ...
        self.model.setUserItemRepFromGraph(self.user_hidden_rep, self.item_hidden_rep, None, None, self.user_hidden_rep_cate_ori, self.item_hidden_rep_cate_ori, None, None) #每次加载相同的hidden representatin, 不合理;
