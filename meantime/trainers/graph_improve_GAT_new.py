...
import os
import pdb
from meantime.dataloaders.graphGAT import GraphLoader
...
class GraphTrainer(AbstractTrainer):
    ...
    @classmethod
    def code(cls):
        return 'graph_sasrec_improve_kgat_new'
    ...
    def train(self):
        ...
        self.model.setUserItemRepFromGraph(self.user_hidden_rep, self.user_hidden_rep, \
                self.user_hidden_rep, self.item_hidden_rep, \
                self.user_hidden_rep_cate_ori, self.user_hidden_rep_cate_ori, \
                self.user_hidden_rep_cate_ori, self.item_hidden_rep_cate_ori)
