...
from meantime.dataloaders.graphGAT_add_side import GraphLoader as GATLoader
...
class GraphTrainer(AbstractTrainer):
    def __init__(self, args, model, train_loader, val_loader, test_loader, local_export_root):
        ...
        self.graph_loader_kgat = GATLoader(self.args, user2id, item2id, attribute2id)
    ...
    def code(cls):
        ...
        return 'graph_sasrec_improve_lightgcn_kgat_add_side_info'
