...
class CellphoneDataset(AbstractDataset):
    @classmethod
    def code(cls):
        return 'food'
    ...
    def url(cls):
        ...
        return 'http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/reviews_Cell_Phones_and_Accessories_5.json.gz'
